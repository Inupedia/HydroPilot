...
- `apps/api/tests/test_fixture.py` — prove existing no-constraint fixture compatibility and fixture filtering.
- `apps/api/tests/test_api_constraints.py` — prove HTTP behavior and provenance preservation.
- scenario in-memory repositories — add empty constraint methods only where protocol compatibility is exercised.
