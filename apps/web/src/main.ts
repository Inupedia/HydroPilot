import { computed, createApp, onBeforeUnmount, onMounted, ref, watch, watchEffect } from 'vue'
  ...
  template: `
    <main class="app-shell">
      <aside class="control-panel">
        ...
        <div class="legend">
          <span><i class="legend-line river"></i>River</span>
          <span><i class="legend-dot reservoir"></i>Reservoir</span>
          <span><i class="legend-dot dam"></i>Dam</span>
          <span><i class="legend-dot gauge"></i>Gauge</span>
          <span><i class="legend-dot control"></i>Control point</span>
        </div>
      </aside>

      <section class="map-stage">
        <div ref="mapHost" class="cesium-host" data-testid="cesium-host"></div>
        <div class="map-header">
          <div><span class="live-dot"></span> CESIUM 3D / EPSG:4326</div>
